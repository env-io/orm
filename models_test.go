...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/env-io/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/env-io/orm.GroupPermissions)"`
}
...
var helpinfo = `need driver and source!
	...
	go get -u github.com/env-io/orm
	...
	go test -v github.com/env-io/orm
